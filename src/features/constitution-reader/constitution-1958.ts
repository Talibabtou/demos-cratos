export const constitution1958 = {
  source: {
    title: 'Constitution du 4 octobre 1958',
    version:
      'Texte en vigueur à jour de la révision constitutionnelle du 8 mars 2024',
    localPdf: '/constitution-1958-vingt-cinquieme-revision.pdf',
    officialUrl:
      'https://qpc360.conseil-constitutionnel.fr/constitution-4-octobre-1958',
  },
  intro: [
  ...
  titles: [
    ...
    },
    {
      id: 'title-5',
      label: 'Titre V',
      name: 'Des rapports entre le Parlement et le Gouvernement',
    },
    {
      id: 'title-6',
      label: 'Titre VI',
      name: 'Des traités et accords internationaux',
    },
    {
      id: 'title-7',
      label: 'Titre VII',
    ...
    },
    {
      id: 'title-10',
      label: 'Titre X',
      name: 'De la responsabilité pénale des membres du Gouvernement',
    },
    {
      id: 'title-11',
      label: 'Titre XI',
      name: 'Le Conseil économique, social et environnemental',
    },
    {
      id: 'title-12',
      label: 'Titre XI BIS',
    ...
    },
    {
      id: 'title-13',
      label: 'Titre XII',
      name: 'Des collectivités territoriales',
    },
    {
      id: 'title-14',
      label: 'Titre XIII',
      name: 'Dispositions transitoires relatives à la Nouvelle-Calédonie',
    },
    {
      id: 'title-15',
      label: 'Titre XIV',
      name: "De la francophonie et des accords d'association",
    },
    {
      id: 'title-16',
      label: 'Titre XV',
      name: "De l'Union européenne",
    },
    {
      id: 'title-17',
      label: 'Titre XVI',
  ...
  articles: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "La loi fixe également les règles concernant : - le régime électoral des assemblées parlementaires, des assemblées locales et des instances représentatives des Français établis hors de France ainsi que les conditions d'exercice des mandats électoraux et des fonctions électives des membres des assemblées délibérantes des collectivités territoriales ; - la création de catégories d'établissements publics ; - les garanties fondamentales accordées aux fonctionnaires civils et militaires de l'État ; - les nationalisations d'entreprises et les transferts de propriété d'entreprises du secteur public au secteur privé.",
    ...
    },
    {
      ...
      title: 'Article 66-1',
      titleId: 'title-8',
      paragraphs: ['Nul ne peut être condamné à la peine de mort.'],
    },
    {
      id: '67',
      title: 'Article 67',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'L’avis est adressé par le président de l’assemblée concernée aux présidents du Parlement européen, du Conseil et de la Commission européenne. Le Gouvernement en est informé.',
  ...
  notes: {
    preamble: [
      {
        title: 'Constitutional block',
        text: 'The preamble points to the 1789 Declaration, the 1946 preamble, and the 2004 Environmental Charter. Courts use these texts when they review legislation.',
      },
      {
        title: 'Read this slowly',
        text: 'This passage does not create one specific institution. It names the sources and values that stand above ordinary statute law.',
      },
    ],
    '1': [
      {
        title: 'Republican identity',
        text: 'Article 1 gathers several founding claims in one place: indivisibility, secularism, democracy, social equality, and decentralization.',
      },
    ],
    '2': [
      {
        title: 'Shared symbols',
        text: 'Language, flag, anthem, motto, and democratic principle sit in the same article. These are the public signs of the Republic.',
      },
    ],
    '3': [
      {
        title: 'National sovereignty',
        text: 'The people are the source of sovereignty, but the Constitution channels its exercise mainly through representatives and referendums.',
      },
    ],
    '4': [
      {
        title: 'Political parties',
        text: 'Parties help express the vote. The Constitution also sets a limit: they must respect national sovereignty and democracy.',
      },
    ],
    '5': [
      {
        title: 'The President as arbiter',
        text: 'This article casts the President as guarantor and arbiter, not only as a political chief. Much of Fifth Republic practice turns on that formula.',
      },
    ],
    '11': [
      {
        title: 'Referendum',
        text: 'Article 11 organizes legislative referendums and, since 2008, the shared-initiative referendum under tight conditions.',
      },
    ],
    '16': [
      {
        title: 'Emergency powers',
        text: 'This is one of the most sensitive articles. In a grave crisis, it places exceptional powers in the President’s hands.',
      },
    ],
    '24': [
      {
        title: 'What Parliament does',
        text: 'Since the 2008 revision, this article says plainly that Parliament passes law, scrutinizes the Government, and evaluates public policy.',
      },
    ],
    '34': [
      {
        title: 'Scope of statute law',
        text: 'This article draws the line between matters for statute law and matters that can fall to regulation. You need it to understand the Fifth Republic.',
      },
    ],
    '49': [
      {
        title: 'Government responsibility',
        text: 'Article 49 contains several ways to engage the Government’s responsibility, including the well-known 49.3 procedure.',
      },
    ],
    '61': [
      {
        title: 'Review before promulgation',
        text: 'This article allows the Constitutional Council to review a law before the President promulgates it.',
      },
    ],
    '61-1': [
      {
        title: 'QPC',
        text: 'Since 2010, the priority question of constitutionality lets people challenge a law already in force when it violates rights or freedoms guaranteed by the Constitution.',
      },
    ],
    '89': [
      {
        title: 'Revision procedure',
        text: 'Article 89 is the ordinary path for changing the Constitution. Both chambers must vote the same text, then the revision goes to a referendum or to Congress.',
      },
    ],
  },
} as const;
